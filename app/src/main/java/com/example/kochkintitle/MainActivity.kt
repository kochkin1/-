package com.example.kochkintitle
...
import com.example.kochkintitle.ui.theme.KochkinTitleTheme
...
@Composable
fun Statya(
    title: String, shortText: String, longText: String, image: Painter, modifier: Modifier = Modifier) {
